...
filter[playerNames] | none | Filters by player name. Usage: filter[playerName]= player1,player2,...
filter[teamNames] | none | Filters by team names. Usage: filter[teamName]= team1,team2,...
